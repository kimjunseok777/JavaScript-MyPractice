/*
    ...
    2. 잔돈이 0원이면 음료수 명을 출력  -->  5
    3. 잔돈이 있으면 잔돈과 함께 음료수 명을 출력  -->  4
    4. 없는 메뉴를 선택하면 "존재하지 않는 상품입니다" 출력  -->  2
    5. 만약 투입 금액이 선택한 음료수 값보다 적을 경우 "금액이 부족합니다" 출력  -->  3
    6. 최소 금액보다 적은 금액을 투입했을 때는 "금액을 잘못 투입하셨습니다" 출력  -->  1
...
function 자판기(coin, product) {
    ...
    if(charge < 0) return console.log('금액이 부족합니다')

    if(charge > 0) return console.log(charge, product)
